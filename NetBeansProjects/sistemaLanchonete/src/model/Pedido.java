...
public class Pedido {
    ...
    private List<Reembolso> reembolso_id;
    private List<Carrinho>carrinho_id;

    public Pedido(Integer id, String hora_pedido, Cliente cliente_id, Integer numero_pedido, Date data_pedido, Status_pedidos status_id, Entrega entrega_id, List<Reembolso> reembolso_id, List<Carrinho> carrinho_id) {
        this.id = id;
    ...
    public List<Reembolso> getReembolso_id() {
        return reembolso_id;
    }

    public void setReembolso_id(List<Reembolso> reembolso_id) {
        this.reembolso_id = reembolso_id;
    }
    ...
    public void setCarrinho_id(List<Carrinho> carrinho_id) {
        this.carrinho_id = carrinho_id;
    }
